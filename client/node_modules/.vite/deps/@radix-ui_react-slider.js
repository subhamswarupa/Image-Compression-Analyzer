...
var Slider = React6.forwardRef(
  (props, forwardedRef) => {
    ...
    const isKeyboardInteractionRef = React6.useRef(false);
...
function SliderThumbProvider(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(SliderThumbContextProvider, { scope: __scopeSlider, ...thumbContext, children: isFunction2(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children });
}
SliderThumbProvider.displayName = THUMB_PROVIDER_NAME;
var THUMB_TRIGGER_NAME = "SliderThumbTrigger";
var SliderThumbTrigger = React6.forwardRef(
  (props, forwardedRef) => {
